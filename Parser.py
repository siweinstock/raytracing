...
def parse(file):
    with open(file) as f:
        for line in f:
            ...
            if arr[0] == "sph":
                ...
                print("Sphere: ", end=' ')
                print(spheres[-1].ctr, spheres[-1].R, spheres[-1].idx)
            elif arr[0] == "cam":
                camera = Camera(*arr[1:])
                print("Camera: ", end=' ')
                ...
                print("Plane: ", end=' ')
                print(planes[-1].N, planes[-1].offset, planes[-1].idx)
            elif arr[0] == "box":
    ...
    # return scene
    return camera, Scene(setting, materials, spheres, planes, boxes, lights)
